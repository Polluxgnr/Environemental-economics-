...
## Anticipated Tough Questions & Plain-English Defenses

**Course:** Environmental Economics — BSc AIDAMS, T1 2026–2027  
**Instructor:** Caterina Seghini · ESSEC Department of Economics  
**Purpose:** Oral examination preparation for Responders 3, 4, and 5 (3-minute live defense).
...
> "The Two-Way Fixed Effects model is the econometrically correct specification. The large negative coefficient in the Country FE model (-0.49) is a classic spurious correlation driven by secular co-trends. Between 1960 and 2023, two things happened at the same time: first, post-war economic growth naturally slowed down from the high-growth 'Trente Glorieuses' of the 1960s to lower trend growth in the 1980s and 2000s; second, global mean temperatures were steadily rising. Because both variables have strong multi-decadal time trends, Country FE correlates the cooler, high-growth 1960s with low temperatures, and the warmer, lower-growth 2010s with high temperatures. Once we add Year Fixed Effects, which absorb common global trends and macro cycles (like the oil shocks and the 2008 crisis), that spurious trend is removed. What remains is idiosyncratic annual weather variation within each country, which has no statistically significant effect on aggregate annual GDP growth."
...
### Q6: "Why did you choose the 1961–1990 baseline rather than the more recent 1991–2020 period?"
**Plain-English Answer:**
...
### Q7: "Why did you choose these specific 8 countries? Isn't 8 countries too small for a global analysis?"
**Plain-English Answer:**
...
### Q8: "How did you pick the coordinates for each country, and does using a single centroid create bias?"
**Plain-English Answer:**
...
### Q9: "Why did you cluster standard errors at the country level?"
**Plain-English Answer:**
...
### Q10: "Can you give documented real-world historical evidence that extreme climate years caused economic losses?"
**Plain-English Answer:**
...
### Q11: "What does the Signal-to-Noise Ratio (SNR) tell us that mean warming alone does not?"
**Plain-English Answer:**
...
### Q12: "Why is seasonal asymmetry economically important? Why does it matter if summers warm faster than winters?"
**Plain-English Answer:**
...
### Q13: "What are the biggest limitations of your study, and what would you do with another month of research?"
**Plain-English Answer:**
